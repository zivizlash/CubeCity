...
namespace CubeCity.Managers
{
    ...
    public class DiamondSquare
    {
        ...
        private readonly double _algseed; // an initial seed value for the corners of the data
        private readonly int _randomSeed;

        public DiamondSquare(int terrainPoints, double roughness, double algseed, int randomSeed)
        {
        ...
        private double[,] DiamondSquareAlgorithm()
        {
            ...
            data[0, 0] = data[0, DATA_SIZE - 1] = data[DATA_SIZE - 1, 0] =
                data[DATA_SIZE - 1, DATA_SIZE - 1] = _algseed;

            var h = _roughness;//the range (-h -> +h) for the average offset - affects roughness
            var r = new Random(_randomSeed);//for the new value in range of h
